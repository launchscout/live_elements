defmodule LiveElementsTestbedWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveElementsTestbedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveElementsTestbedWeb.Gettext, "errors", msg, opts)
    end
  end
